...
class Menu:
    def __init__(self, game):
        ...
        self.font_cache[20] = self.font  # Cache the default font
    ...
    def draw_cursor(self):
        self.game.display.blit(
            self.cursor_img, (self.cursor_rect.x + self.offset, self.cursor_rect.y)
        )
    ...
    def move_cursor(self):
        ...
        self.cursor_rect.center = (
            ...
            self.game.DISPLAY_H / 2 + (self.index * self.newline),
        )
